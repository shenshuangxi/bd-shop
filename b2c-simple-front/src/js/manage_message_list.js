...
define(['jquery', "components", "bootstrap", "manageCommon"], function(jquery, components, bootstrap, manageCommon) {
    ...
    function getModules() {
        ...
        //    crossDomain: true,
        //}).done(function (msg) {
        components.getMsg(apiUrl + "/admin/module/module/queryModules?lid=4").done(function (msg) {
            if (msg.res == 1) {
                var objList = msg.obj;
    ...
    listUrl = apiUrl + "/admin/message/messageAdmin/getMessageByPage";
    require(['./table']);
    ...
    function delMessage() {
        $("#table-list-content").on("click", ".del-btn", function() {
            var url = apiUrl + "/admin/message/messageAdmin/delMessage?messageId=" + $(this).attr("god");
